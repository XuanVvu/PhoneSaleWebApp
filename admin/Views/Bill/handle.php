     ...
     <table class="table table-dark table-hover">
       ...
       <?php foreach ($data as $r) : ?>
         <tr>
           ...
           <td><a onclick="return confirm('bạn có muốn xử lý đơn hàng này không ?')" href="<?php echo DIR_HTTP ?>/BillController/BillHandle/<?php echo $r['ma_don_hang'] ?>"><i class="fa-solid fa-dollar-sign fa-2x"></i></a></td>
